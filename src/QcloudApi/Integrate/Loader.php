 ...
 *     require_once '[SDK下的src目录]/QcloudApi/Integrate/Loader.php';
...
class Loader{
    ...
    const ALLOW_CLASSNAME_PREFIX = 'QcloudApi';
    ...
    /**
     * 获取单例
     * @return \QcloudApi\Integrate\Loader
     */
